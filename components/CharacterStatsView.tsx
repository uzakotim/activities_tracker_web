    ...
    <div className="space-y-8 animate-fadeIn max-w-6xl mx-auto pb-12">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-[#101A36]/90 border border-slate-700/80 p-6 sm:p-8 backdrop-blur-xl shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 sm:gap-4 w-full md:w-auto justify-between sm:justify-start border-t md:border-t-0 pt-4 md:pt-0 border-slate-800">
            <div className="bg-slate-900/80 border border-slate-800 rounded-xl px-4 py-2.5 text-center min-w-[90px]">
        ...
        <div className="mt-6 pt-5 border-t border-slate-800/80">
          <div className="flex items-center justify-between text-xs mb-2">
            <span className="text-slate-400 font-medium">Daily Attribute Alignment</span>
